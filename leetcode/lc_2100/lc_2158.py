...
where paint[i] = [starti, endi]. This means that on the ith day you need
to paint the area between starti and endi.
...
On day 1, paint nothing because everything between 2 and 4
...
class Solution:
    def amountPainted(self, paint: list[list[int]]) -> list[int]:
        return self.amount_painted(paint)
