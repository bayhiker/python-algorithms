...
You are asked to design a file system which provides two functions:
    ...
    createPath(path, value): Creates a new path and associates a value
       to it if possible and returns True. Returns False if the path
       already exists or its parent path doesn't exist.
    get(path): Returns the value associated with a path or
...
"""
Use hash or trie to store path elements
hash is easier to implement and understand
trie doesn't have hash conflict problem
"""
